        ...
        $(function () {
            ...
            $('#dataList').datagrid({
                ...
                columns: [[
                    ...
                    {field: 'introducation', title: '简介', width: 220}
                ]],
                toolbar: "#toolbar"//工具栏
            });
    ...
    <form id="addForm" method="post" action="#">
        <table id="addTable" style="border-collapse:separate; border-spacing:0 3px;" cellpadding="6">
            ...
            <tr>
                <td>姓名</td>
                <td colspan="1">
                    <input id="add_name" name="name" style="width: 200px; height: 30px;" class="easyui-textbox"
                           type="text"  data-options="required:true, missingMessage:'请填写姓名哟~'"/>
                </td>
            </tr>
            <tr>
                <td>性别</td>
