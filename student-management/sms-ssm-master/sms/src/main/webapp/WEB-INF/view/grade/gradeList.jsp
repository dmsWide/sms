        ...
        $(function () {
            ...
            $("#search-btn").click(function () {
                $('#dataList').datagrid('load', {
                    gradename: $('#search-gradename').val()//获取年级名称
                });
            });
    ...
    <form id="addForm" method="post" action="#">
        <table id="addTable" style="border-collapse:separate; border-spacing:0px 3px;" cellpadding="6">
            ...
            <tr>
                <td>年级主任</td>
                <td colspan="1">
                    <input id="add_manager" style="width: 200px; height: 30px;" class="easyui-textbox"
                           type="text" name="manager" data-options="required:true, missingMessage:'请填写主任姓名哟~'"/>
                </td>
            </tr>
            <tr>
                <td>主任邮箱</td>
